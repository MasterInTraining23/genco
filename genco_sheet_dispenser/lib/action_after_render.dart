...
class ActionAfterRender extends StatefulWidget {
  final int timeUntilRestart;
  final CoordinationModel coordinationModel;

  const ActionAfterRender(
      {super.key,
      required this.timeUntilRestart,
      required this.coordinationModel});

  @override
  _ActionAfterRenderState createState() => _ActionAfterRenderState();
}

class _ActionAfterRenderState extends State<ActionAfterRender> {
