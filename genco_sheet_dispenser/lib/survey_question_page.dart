...
class _SurveyQuestionPageState extends State<SurveyQuestionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    questionPromptTitle = convertDynamicsToString(
        questionPromptTitle ?? pageInfo["questionPromptTitle"]);
    questionPromptSubtitle = convertDynamicsToString(
        questionPromptSubtitle ?? pageInfo["questionPromptSubtitle"]);
    questionAnswer =
        convertDynamicsToBool(questionAnswer ?? pageInfo["questionAnswer"]);
    answerChoices =
        convertDynamicsToString(answerChoices ?? pageInfo["answerChoices"]);
    selectedChoices =
